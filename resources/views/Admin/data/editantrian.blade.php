                ...
                <div class="tab-pane show px-7 active" id="kt_user_edit_tab_1" role="tabpanel">
                    ...
                    <div class="row">
                        ...
                        <div class="col-xl-7 my-2">
                            ...
                            <form action="{{ route('admin.data.editedantrian',['data' => $data->id]) }}" method="POST" enctype="multipart/form-data">
                            @method('PATCH')
                            @csrf
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-9">
                                    <input class="form-control form-control-lg form-control-solid @error('alamat') is-invalid @enderror" type="text" name="alamat" id="alamat" placeholder="Masukkan Alamat" value="{{ old('alamat') ?? $data->alamat }}">
                                     @error('alamat')
					                 <div class="text-danger">{{ $message }}</div>
					                 @enderror
                                </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-9">
                                    <input class="form-control form-control-lg form-control-solid @error('nomor') is-invalid @enderror" type="text" name="nomor" id="nomor" placeholder="Masukkan Nomor Telpon" value="{{ old('nomor') ?? $data->nomor }}">
                                    @error('nomor')
					                 <div class="text-danger">{{ $message }}</div>
					                 @enderror
                                </div>
