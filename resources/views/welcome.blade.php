...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <div id="coodiv-header" class="d-flex mx-auto flex-column moon-edition"><!-- start header -->
       ...
       <!--  <img src="{{ asset('bredh/img/header/h_bg_02.svg') }}" alt="img-bg"> -->
        ...
        <nav id="coodiv-navbar-header" class="navbar navbar-expand-md fixed-header-layout">
            <div class="container main-header-coodiv-s">
				...
				<img class="w-logo" src="{{ asset('bredh/img/header/sion.png') }}" alt="" />
				<img class="b-logo" src="{{ asset('bredh/img/header/sion.png') }}" alt="" />
