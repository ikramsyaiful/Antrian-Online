...
<html lang="en" >
    ...
    <head><base href="">
        ...
        <link rel="stylesheet" href="https://fonts.googleapis.com/css?family=Poppins:300,400,500,600,700"/>        <!--end::Fonts-->
                    ...
                    <!--begin::Page Vendors Styles(used by this page)-->
                            <link href="{{ asset('public/metronicaadmin/dist/assets/plugins/custom/fullcalendar/fullcalendar.bundle.css?v=7.0.6') }}" rel="stylesheet" type="text/css"/>
                            <link href="{{ asset('public/metronicaadmin/dist/assets/plugins/custom/leaflet/leaflet.bundle.css?v=7.0.6') }}" rel="stylesheet" type="text/css"/>
                        <!--end::Page Vendors Styles-->


        <!--begin::Global Theme Styles(used by all pages)-->
                    <link href="{{ asset('public/metronicaadmin/dist/assets/plugins/global/plugins.bundle.css?v=7.0.6') }}" rel="stylesheet" type="text/css"/>
                    <link href="{{ asset('public/metronicaadmin/dist/assets/plugins/custom/prismjs/prismjs.bundle.css?v=7.0.6') }}" rel="stylesheet" type="text/css"/>
                    <link href="{{ asset('public/metronicaadmin/dist/assets/css/style.bundle.css?v=7.0.6') }}" rel="stylesheet" type="text/css"/>
                <!--end::Global Theme Styles-->

        <!--begin::Layout Themes(used by all pages)-->
                <!--end::Layout Themes-->

        <link rel="shortcut icon" href="{{ asset('public/metronicaadmin/dist/assets/media/logos/favicon.ico') }}"/>
	...
	<!--begin::Logo-->
	<a href="index.html">
		<img alt="Logo" src="{{ asset('public/metronicaadmin/dist/assets/media/logos/logo-letter-3.png') }}" class="logo-default max-h-40px"/>
	</a>
	<!--end::Logo-->
...
<div class="aside aside-left d-flex flex-column " id="kt_aside">
	...
	<div class="aside-brand d-flex flex-column align-items-center flex-column-auto py-4 py-lg-8">
		<!--begin::Logo-->
		<a href="index.html">
			<img alt="Logo" src="{{ asset('public/metronicaadmin/dist/assets/media/logos/logo-letter-9.png') }}" class="max-h-40px"/>
		</a>
		<!--end::Logo-->
	</div>
	<!--end::Brand-->
...
<div class="dropdown">
				...
				<div class="topbar-item mr-3" data-toggle="dropdown" data-offset="10px,0px" aria-expanded="false">
					...
					<div class="d-flex flex-column text-right pr-3">
						...
						<span class="text-dark-75 font-weight-bolder font-size-base d-none d-md-inline">Super Admin</span>
					</div>
...
<div class="footer bg-white py-4 d-flex flex-lg-column " id="kt_footer">
	...
	<div class=" container  d-flex flex-column flex-md-row align-items-center justify-content-between">
		...
		<div class="text-dark order-2 order-md-1">
			...
			<a href="" target="_blank" class="text-dark-75 text-hover-primary">Antrian</a>
		</div>
		<!--end::Copyright-->
...
<div id="kt_demo_panel" class="offcanvas offcanvas-right p-10">
    ...
    "font-family": "Poppins"
    	...
    	<!--begin::Global Theme Bundle(used by all pages)-->
    	    	   <script src="{{ asset('public/metronicaadmin/dist/assets/plugins/global/plugins.bundle.js?v=7.0.6') }}"></script>
		    	   <script src="{{ asset('public/metronicaadmin/dist/assets/plugins/custom/prismjs/prismjs.bundle.js?v=7.0.6') }}"></script>
		    	   <script src="{{ asset('public/metronicaadmin/dist/assets/js/scripts.bundle.js?v=7.0.6') }}"></script>
				<!--end::Global Theme Bundle-->

                    <!--begin::Page Vendors(used by this page)-->
                            <script src="{{ asset('public/metronicaadmin/dist/assets/plugins/custom/fullcalendar/fullcalendar.bundle.js?v=7.0.6') }}"></script>
                            <script src="{{ asset('public/metronicaadmin/dist/assets/plugins/custom/leaflet/leaflet.bundle.js?v=7.0.6') }}"></script>
                        <!--end::Page Vendors-->

                    <!--begin::Page Scripts(used by this page)-->
                            <script src="{{ asset('public/metronicaadmin/dist/assets/js/pages/widgets.js?v=7.0.6') }}"></script>
                        <!--end::Page Scripts-->
                                            <!--begin::Page Scripts(used by this page)-->
                            <script src="{{ asset('public/metronicaadmin/dist/assets/js/pages/custom/user/edit-user.js?v=7.0.6') }}"></script>
                        <!--end::Page Scripts-->
            </body>
    <!--end::Body-->
</html>
