...
<html lang="en" >
    ...
    <head><base href="">
        ...
        <link rel="stylesheet" href="https://fonts.googleapis.com/css?family=Poppins:300,400,500,600,700"/>        <!--end::Fonts-->
                    ...
                    <!--begin::Page Vendors Styles(used by this page)-->
                            <link href="{{ asset('metronicaadmin/dist/assets/plugins/custom/fullcalendar/fullcalendar.bundle.css?v=7.0.6') }}" rel="stylesheet" type="text/css"/>
                            <link href="{{ asset('metronicaadmin/dist/assets/plugins/custom/leaflet/leaflet.bundle.css?v=7.0.6') }}" rel="stylesheet" type="text/css"/>
                        <!--end::Page Vendors Styles-->


        <!--begin::Global Theme Styles(used by all pages)-->
                    <link href="{{ asset('metronicaadmin/dist/assets/plugins/global/plugins.bundle.css?v=7.0.6') }}" rel="stylesheet" type="text/css"/>
                    <link href="{{ asset('metronicaadmin/dist/assets/plugins/custom/prismjs/prismjs.bundle.css?v=7.0.6') }}" rel="stylesheet" type="text/css"/>
                    <link href="{{ asset('metronicaadmin/dist/assets/css/style.bundle.css?v=7.0.6') }}" rel="stylesheet" type="text/css"/>
                <!--end::Global Theme Styles-->

        <!--begin::Layout Themes(used by all pages)-->
                <!--end::Layout Themes-->

        <link rel="shortcut icon" href="{{ asset('metronicaadmin/dist/assets/media/logos/favicon.ico') }}"/>
	...
	<!--begin::Logo-->
	<a href="index.html">
		<img alt="Logo" src="{{ asset('metronicaadmin/dist/assets/media/logos/logo-letter-3.png') }}" class="logo-default max-h-30px"/>
	</a>
	<!--end::Logo-->
...
<div class="aside aside-left d-flex flex-column " id="kt_aside">
	...
	<div class="aside-brand d-flex flex-column align-items-center flex-column-auto py-4 py-lg-8">
		<!--begin::Logo-->
		<a href="index.html">
			<img alt="Logo" src="{{ asset('metronicaadmin/dist/assets/media/logos/logo-letter-9.png') }}" class="max-h-30px"/>
		</a>
		<!--end::Logo-->
	</div>
	<!--end::Brand-->
...
<div id="kt_demo_panel" class="offcanvas offcanvas-right p-10">
    ...
    "font-family": "Poppins"
    	...
    	<!--begin::Global Theme Bundle(used by all pages)-->
    	    	   <script src="{{ asset('metronicaadmin/dist/assets/plugins/global/plugins.bundle.js?v=7.0.6') }}"></script>
		    	   <script src="{{ asset('metronicaadmin/dist/assets/plugins/custom/prismjs/prismjs.bundle.js?v=7.0.6') }}"></script>
		    	   <script src="{{ asset('metronicaadmin/dist/assets/js/scripts.bundle.js?v=7.0.6') }}"></script>
				<!--end::Global Theme Bundle-->

                    <!--begin::Page Vendors(used by this page)-->
                            <script src="{{ asset('metronicaadmin/dist/assets/plugins/custom/fullcalendar/fullcalendar.bundle.js?v=7.0.6') }}"></script>
                            <script src="{{ asset('metronicaadmin/dist/assets/plugins/custom/leaflet/leaflet.bundle.js?v=7.0.6') }}"></script>
                        <!--end::Page Vendors-->

                    <!--begin::Page Scripts(used by this page)-->
                            <script src="{{ asset('metronicaadmin/dist/assets/js/pages/widgets.js?v=7.0.6') }}"></script>
                        <!--end::Page Scripts-->
                                            <!--begin::Page Scripts(used by this page)-->
                            <script src="{{ asset('metronicaadmin/dist/assets/js/pages/custom/user/edit-user.js?v=7.0.6') }}"></script>
                        <!--end::Page Scripts-->
            </body>
    <!--end::Body-->
</html>
