...
@section('isi')
          ...
          <div class="row heading-bg">
						...
						<!--
						<div class="col-lg-2 col-md-2 col-sm-3 col-xs-12">
							<button onClick="window.open('');" class="btn btn-primary btn-rounded-anim  btn-anim"><i class="fa fa-plus"></i><span class="btn-text">Tampilkan Antrian</span></button>
						</div>-->
					</div>
...
<div class="row">
    @forelse ($data as $datas)
                        ...
                        <li role="presentation"><a href="{{ route('reset',['data' => $datas->id]) }}" role="menuitem"><i class="zmdi zmdi-play" aria-hidden="true"></i>Reset</a></li>
								...
								<div class="panel-wrapper collapse in">
									<div class="panel-body row">
											...
											<div class="mb-15">
                                                ...
                                                <div class="col-md-6">
                                                    ...
                                                    <center><li class="list-inline-item">
                                                        <h4 class="mb-0">{{$datas->antri_jalan > 0 ? $datas->antri_jalan - 1 : $datas->antri_jalan}}</h4>
										...
										<div class="emp-detail pl-15 pr-15" style="background-color: #337ab7;">
											<div class="mb-5">
											<form id="aktivasiForm" action="{{ route('aktivasi', ['id' => $datas->id]) }}" method="POST">
													@csrf
													@method('PATCH')
													<!-- Add any form fields or data you need to submit -->
													<button type="submit" class="btn btn-tumblr btn-icon-anim btn-block btn-anim" style="background-color: #D6E7F5;"
															onclick="{{ $datas->antri_jalan >= 1 ? "window.open('" . route('data_antri.verifikasi', ['data' => $datas->id]) . "'); return false;" : "document.getElementById('aktivasiForm').submit();"}}">
															<i class="glyphicon glyphicon-qrcode"></i>
															<span class="btn-text">{{ $datas->antri_jalan >= 1 ? "Scan" : "Aktifkan" }}</span>
													</button>
											</form>
                            </div>
										</div>
