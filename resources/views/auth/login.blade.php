        ...
        <div class="auth-content">
            ...
            <div class="card">
                ...
                <div class="card-body text-center">
                    <a class="auth-content-logo-header" href="index.html"><img src="img/header/logo-w-f.png" alt=""></a>
                    <img src="{{ asset('bredh/img/header/sion.png') }}" alt="" />
                    <h3 class="mb-4 auth-login-title">Login</h3>
                    ...
                    <button type="submit" class="btn btn-login-auth shadow-2 mb-4">Masuk</button>
