                    ...
                    <div class="row">
                        ...
                        <div class="col-xl-7 my-2">
                            ...
                            <!--end::Row-->
                              ...
                              <form action="{{ route('admin.data.antrianupdate',['data' => $data->id]) }}" method="POST" enctype="multipart/form-data">
                              @csrf
                              @method('PATCH')
														<div class="form-body">
															<div class="row">
																<div class="col-md-12">
																	<div class="form-group">
																		...
																		<input  id="name" name="name" class="form-control form-control-lg form-control-solid @error('name') is-invalid @enderror" value="{{ old('name') ?? $data->name }}" placeholder="Masukkan Nama Antrian">
                                                                        @error('name')
															...
															<div class="row">
																<div class="col-md-12">
																	<div class="form-group">
																		...
																		<input  id="deskripsi" name="deskripsi" class="form-control form-control-lg form-control-solid @error('deskripsi') is-invalid @enderror" value="{{ old('name') ?? $data->deskripsi }}" placeholder="Masukkan Alamat">
                                                                         @error('deskripsi')
                                                                        <div class="text-danger">{{ $message }}</div>
                                                                         @enderror
																	</div>
															...
															<div class="row">
																...
																<div class="col-md-6">
																	<div class="form-group">
																		...
																		<input type="text" class="form-control form-control-lg form-control-solid @error('nomor_antri') is-invalid @enderror" id="nomor_antri" name="nomor_antri" value="{{ old('nomor_antri') ?? $dataz->nomor_antri }}" placeholder="Pengantri">
                                                                         @error('nomor_antri')
                                                                        <div class="text-danger">{{ $message }}</div>
                                                                         @enderror
																	</div>
																...
																<div class="col-md-6">
																	<div class="form-group">
																		...
																		<input type="text" class="form-control form-control-lg form-control-solid @error('antri_jalan') is-invalid @enderror" id="antri_jalan" name="antri_jalan" value="{{ old('antri_jalan') ?? $dataz->antri_jalan }}" placeholder="Antri Jalan">
                                                                         @error('antri_jalan')
                                                                        <div class="text-danger">{{ $message }}</div>
                                                                         @enderror
																	</div>
														...
														<center>	<button type="submit" class="btn btn-success  mr-10"> Update</button>
                                                            </form>
															<button type="button" class="btn btn-default" onclick="window.history.go(-1); return false;">Cancel</button></center>
														</div>  
                            <!--end::Group-->
                        </div>
                    </div>
