...
@section('viewleft')
			...
			<li class="nav-item mb-5" data-toggle="tooltip" data-placement="right" data-container="body" data-boundary="window" title="Daftar Antrian">
				<a href="{{route('admin.data.viewdaftarantrian')}}" class="nav-link btn btn-icon btn-clean btn-icon-white btn-lg active" >
        ...
        <div class="d-flex align-items-center flex-wrap mr-2">
            ...
            <div class="d-flex align-items-center" id="kt_subheader_search">
                <span class="text-dark-50 font-weight-bold" id="kt_subheader_total">
                                            {{$total}} Total                            </span>
                                   <form class="ml-5"  action="/admin/data/viewdaftarantrian/cari" method="GET">
