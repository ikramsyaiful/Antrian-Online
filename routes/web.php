...
Route::group(['middleware' => ['auth']], function () {
    ...
    //aktivasi//
    //--------//
    Route::patch('/show/{id}', 'Data\Table\Fungsi\FungsiController@aktivasi')->name('aktivasi');
		//------------------------------
    ...
    //-------------------------------------------------------
		//reset//
		 Route::get('/show/reset/{data}', 'Data\Table\Fungsi\FungsiController@areset')->name('reset');
		//-------------------------------------------------------
  ...
  //  Route::get('/data_antri/{data}', 'Data\Table\View\ViewController@show')->name('data_antri.show');
    ...
    Route::get('/data_antri/verifikasi/{data}', 'Data\Table\View\ViewController@verifikasiview')->name('data_antri.verifikasi');
		Route::post('/data_antri/verifikasi/{data}', 'Data\Table\Fungsi\FungsiController@verifikasiskip')->name('data_antri.verifikasiskip');
    //--------------------------------------------------------
});
...
//Admin masuk
    ...
    Route::group(['middleware' => ['is_admin']], function () {
            ...
            Route::get('/admin/delete/aktifkan/{data}', 'Admin\AdminFungsiController@aktifantrian')->name('admin.data.aktifantrian');
            //------------------
