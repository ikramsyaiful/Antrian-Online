                    ...
                    if($ini){
                        ...
                        $ini->random=$ab;         
                            if($ini->qrcode){
                                ...
                                $isi->save();											 
								    if ($ini->nomor_antri == 1 || $ini->nomor_antri < $ini->antri_jalan || $ini->nomor_antri == $ini->antri_jalan ) {
										$ini->save();
									} else {
										$msg = "";
									}
	...
	{        
       ...
       if($key==$same){
         ...
         return view('data_antri.verifikasi')->with($data);
				 ...
				 return redirect()->route('index')->with('success', 'Aktifkan Antrian Terlebih Dahulu');
